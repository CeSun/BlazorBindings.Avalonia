...
namespace Blazonia.Components.Primitives
{
    ...
    /// </summary>
    public partial class HeaderedItemsControl<T> : Blazonia.Components.ItemsControl<T>
    {
        ...
        protected override void RenderAdditionalElementContent(RenderTreeBuilder builder, ref int sequence)
        {
            ...
            RenderTreeBuilderHelper.AddDataTemplateProperty<ACP.HeaderedItemsControl, object>(builder, sequence++, HeaderTemplate,
