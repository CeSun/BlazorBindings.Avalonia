...
{
    const string AvaloniaComponentsNamespace = "BlazorBindingsAvalonia.Elements";
...
";
        ...
        var usings = new List<UsingStatement>
            {
                ...
                new UsingStatement { Namespace = "BlazorBindingsAvalonia.Core", IsUsed = true, IsGlobalUsing = true },
    ...
    private string GetComponentNamespace(INamedTypeSymbol typeToGenerate)
    {
        ...
        return string.IsNullOrEmpty(group) ? "BlazorBindingsAvalonia.Elements" : $"BlazorBindingsAvalonia.Elements.{group}";
    }
